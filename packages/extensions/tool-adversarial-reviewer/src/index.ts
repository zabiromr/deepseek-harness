 ...
 * @module @deepseek-ai/dsh-tool-adversarial-reviewer
 */
...
export const name = 'tool-adversarial-reviewer'
...
const DESCRIPTION = 'Self-critique via subagent review.'

export function apply(ctx: Context, config: Config): void {
  if (!config.enabled) return
  ctx.tools.register(defineTool({
    name: 'tool-adversarial-reviewer',
    ...
    output: {
      ...
      render: (_args, _value) => [{ type: 'text', text: 'Self-critique via subagent review.: done' }],
    },
    execute(_args, _exec) {
