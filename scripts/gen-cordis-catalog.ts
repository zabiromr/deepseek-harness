...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DecayParams: 'memory.md',
  DigestQuery: 'memory.md',
  Lesson: 'memory.md',
  LessonEvidence: 'memory.md',
  LessonId: 'memory.md',
  LessonScope: 'memory.md',
  LessonStatus: 'memory.md',
  RecallQuery: 'memory.md',
  ReclassifySummary: 'memory.md',
  RecordLessonRequest: 'memory.md',
  SessionFileListRequest: 'session.md',
  SessionFileListValue: 'session.md',
  SessionFileReadRequest: 'session.md',
  SessionFileReadValue: 'session.md',
  SessionFileWriteRequest: 'session.md',
  SessionFileWriteValue: 'session.md',
