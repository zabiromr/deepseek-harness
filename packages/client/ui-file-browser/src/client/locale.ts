...
export const zh = {
  ...
  'fileBrowser.conflict': '该文件自打开后已被改动；保存会覆盖新内容。',
  'fileBrowser.reload': '重新载入',
...
export const en = {
  ...
  'fileBrowser.conflict': 'This file changed since you opened it; saving would overwrite the newer content.',
  'fileBrowser.reload': 'Reload',
